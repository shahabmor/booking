...
class Unit(models.Model):
    ...
    facilities = models.ManyToManyField(Facility, related_name='units', default=None, null=True)
    policies = models.ManyToManyField(Policy, related_name='units', default=None, null=True)
...
class Hotel(models.Model):
    ...
    units = models.ManyToManyField(Unit, related_name='hotels', default=None, null=True)
    facilities = models.ManyToManyField(Facility, related_name='hotels', default=None, null=True)
    policies = models.ManyToManyField(Policy, related_name='hotels', default=None, null=True)
